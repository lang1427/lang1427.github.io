...
<style scoped>
.scroll-nav-bar .scroll-navbar-list {
  height: 40px;
  line-height: 40px;
...
.scroll-nav-bar .list-wrapper {
  display: flex;
}
.scroll-nav-bar .list-item {
  flex: 1;
  white-space: nowrap;
  padding: 0 15px;
  cursor: pointer;
}
.scroll-nav-bar .list-item.item-active {
  border-bottom: 2px solid red;
}
.scroll-nav-bar .list-item.item-active span {
  color: red;
}
</style>
